...
- Add date formatting setting for OpenArchives collections to select how to show the date metadata, changed Solr date format to String instead of Date to allow for flexibility of EDTF date formats
